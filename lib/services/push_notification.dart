...
class PushNotificationsManager {
  ...
  Future<void> init() async {
    ...
    var initializationSettingsAndroid = const AndroidInitializationSettings('@mipmap/ic_stat');
  ...
  Future<void> _demoNotification(String title, String body) async {
    ...
    var iOSChannelSpecifics = IOSNotificationDetails(sound: 'default',presentBadge: true,presentSound: true,badgeNumber: 1,presentAlert: true,
    subtitle: "Test");
